...
#'data casting is the transfomation of data types based off of  w3schools
'i would use int()'

# 2. Create a list called numbCol that contains three (3 ) colors and three (3) numbers.
numbcol=['red','blue','green',1,2,3]#{}are for objects
...
def schoolprison():
 if not (userLoan==true and beenTocolleg==true):
   print('here is your paper yay')
elif userLoan==true and beenTocolleg==false:
elif userLoan=="true'and bee
if not (userLoan==true and beenTocolleg==true):
   print('here is your paper yay')
else:
    print('byebye')
schoolprison(true,false) #i got lost but i think i got the idea 