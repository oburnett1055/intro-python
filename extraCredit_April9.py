...
# a paramter or by using the input function.count()	Returns the number of times a specified value occurs in a string
def lettersAndNumbers(talk):
    x=len(talk)
    print(x)
lettersAndNumbers('bob')
