...
# keywords
#use preexisting refernce
#Use a function that allows connection between the app and home 

#BREAKDOWN
#research preexisting apps
# breakdown the the passage into simple 1,2,3, request 
#after i would use my research to make the request step by step
#the connect the steps to create a full code

# 1. Based on the prompt you just read, what is the main goal(s) of the app that you are creating?
# What is the primary objective of your app? Please write your response using complete a complete sentence.to create a mobile controller for the activity of your home
...
# keywords
#use preexisting refernce
#then find a function that allows connection between the app and home location true or false return of information camera codes and buttons
...
def lightsout(livingroom,bedroom,):
    livingroom=False
    bedroom=False
    bath=False
    home=[livingroom,bedroom,bath]
    userinput=int(input('please enter a room key living room = 0 bath =2 bed room =1'))
    for room in home:
       if home[room]==userinput:
          home[room]=True
          print(home)
